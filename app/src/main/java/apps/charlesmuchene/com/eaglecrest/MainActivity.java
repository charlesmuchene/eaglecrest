...
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer
{
    ...
    private EagleCrestOverlayView overlayView;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        overlayView = (EagleCrestOverlayView) findViewById(R.id.overlay);
        overlayView.show3DToast("Vuta hiyo Smakoh ukipata box");
    } // on create
    ...
    {
        GLES20.glClearColor(0.1f, 0.1f, 0.1f, 0.5f); // background
